ALTER TABLE "invites" DROP CONSTRAINT IF EXISTS "invites_invitee_id_team_id";--> statement-breakpoint
ALTER TABLE "scans" DROP CONSTRAINT IF EXISTS "scans_user_id_event_id";--> statement-breakpoint
