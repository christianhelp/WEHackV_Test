		...
		<section className="jumbotron parent-container" id="home">
			...
			<div className="jumboText-container flex flex-col items-center justify-center text-center">
				<div className="jumbo-group">
					<h4 className="jumbo-text font-serif text-sm text-[#FFE9D7] lg:text-lg">
						WEHack Presents
					</h4>
					<h1 className="jumbo-title animate-pulse text-9xl text-[#FFE9D7] md:text-5xl lg:text-5xl">
						WEHack 2025
					</h1>
					<h2 className="jumbo-text text-l font-thin text-[#FFE9D7] md:text-5xl lg:text-5xl">
						COMING SOON
					</h2>
					<h3 className="jumbo-text md:2xl text-sm font-extralight text-[#FFE9D7] sm:text-2xl lg:text-3xl">
						April 2025
					</h3>

					<div className="jumbo-buttons flex flex-col items-center">
						<Button
							link={"https://events.mlh.io/events/11456-wehack"}
					...
					<div className="countdown">
						...
						<div>
							<img
								className="wehack-stats-mascot h-auto max-w-60 scale-x-[-1] sm:max-w-64 md:max-w-72 lg:max-w-72"
